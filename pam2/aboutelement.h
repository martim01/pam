...
class  AboutElement : public advElement
{
    public:
        ...
        AboutElement(wxDC& dc, unsigned int nWidth, const wxString& sName, const wxString& sVersion, const wxString& sDate, const wxString& sTag, const wxString& sBranch);
    ...
    protected:
        ...
        enum{ID_NAME, ID_VERSION, ID_DATE_LABEL, ID_DATE, ID_TAG_LABEL, ID_TAG, ID_BRANCH_LABEL, ID_BRANCH, ID_ENCLOSING};

        static const wxColour CLR_LABEL;
        static const wxColour CLR_DATA;
        static const wxColour CLR_BACK;

        unsigned long HEIGHT_TITLE = 30;
