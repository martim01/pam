...
pnlTestOptions::pnlTestOptions(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	//*)
	m_pbtnLog->SetToggle(true, wxT("Off"), wxT("On"),50);
    ...
    Connect(m_pbtnLogView->GetId(),wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlTestOptions::OnbtnLogViewClick);
}
