...
namespace AutoVersion{
	...
	static const long BUILD  = 1400;
	static const long REVISION  = 7773;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 3408;
	#define RC_FILEVERSION 1,0,1400,7773
	#define RC_FILEVERSION_STRING "1, 0, 1400, 7773\0"
	static const char FULLVERSION_STRING [] = "1.0.1400.7773";
