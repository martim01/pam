...
//enum inviteAESClientState { Calling, Proceeding, Completed, Terminated };

class AES67Client: public Medium {
public:
  static AES67Client* createNew(UsageEnvironment& env,
...
private:
  AES67Client(UsageEnvironment& env,
	    unsigned char desiredAudioRTPPayloadFormat,
