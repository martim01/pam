...
def create_tar(filename):
 ...
 tarObj.add('lib/monitor', arcname='lib/pam2/monitor', recursive=True, filter=filter_debug)
 tarObj.add('lib/test', arcname='lib/pam2/test', recursive=True, filter=filter_debug)
 tarObj.add('lib/generator', arcname='lib/pam2/generator', recursive=True, filter=filter_debug)
