...
[CLASS_PREFIX]Builder::[CLASS_PREFIX]Builder() : MonitorPluginBuilder()
{
...
wxWindow* [CLASS_PREFIX]Builder::CreateMonitorPanel(wxWindow* pParent)
{
...
list<pairOptionPanel_t> [CLASS_PREFIX]Builder::CreateOptionPanels(wxWindow* pParent)
{
