...
AES67RTPSink::AES67RTPSink(UsageEnvironment& env, Groupsock* RTPgs, unsigned int nFrameSize) : AudioRTPSink(env, RTPgs, Settings::Get().Read("Server", "RTPMap", 96), 48000, "L24", 2)  // @todo allow setting of channels etc
{
