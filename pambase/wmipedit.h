...
**/
class  wmIpEdit : public wxControl
{
    ...
    public:
        ...
        *   @param size the size of the control
        **/
        wmIpEdit(wxWindow* pParent, wxWindowID id, unsigned int nDateFormat, unsigned int nTimeFormat, unsigned int nFrames, bool bTimeFirst = true, wxChar chDate=wxT('/'), wxChar chTime=wxT(':'), const wxPoint& pos = wxDefaultPosition,const wxSize& size = wxDefaultSize);
