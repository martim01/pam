...
namespace AutoVersion{
	...
	static const long REVISION  = 2002;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 389;
	#define RC_FILEVERSION 1,0,365,2002
	#define RC_FILEVERSION_STRING "1, 0, 365, 2002\0"
	static const char FULLVERSION_STRING [] = "1.0.365.2002";
