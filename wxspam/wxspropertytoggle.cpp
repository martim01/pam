...
wxsPropertyToggle::wxsPropertyToggle(long nLineOffset, const wxString& PGName,const wxString& DataName,int Priority):
    wxsCustomEditorProperty(PGName,DataName,Priority),
    m_nLineOffset(nLineOffset)
{}

bool wxsPropertyToggle::ShowEditor(wxsPropertyContainer* pObject)
{
...
bool wxsPropertyToggle::XmlRead(wxsPropertyContainer* pObject,TiXmlElement* pElement)
{
    LINES.clear();
...
bool wxsPropertyToggle::XmlWrite(wxsPropertyContainer* pObject,TiXmlElement* pElement)
{
...
void wxsPropertyToggle::AppendProperty(TiXmlElement* pParent, wxString sProperty, wxString sValue)
{
...
bool wxsPropertyToggle::PropStreamRead(wxsPropertyContainer* pObject,wxsPropertyStream* pStream)
{

    return true;
}

bool wxsPropertyToggle::PropStreamWrite(wxsPropertyContainer* pObject,wxsPropertyStream* pStream)
{

    return true;
}

wxString wxsPropertyToggle::GetStr(wxsPropertyContainer* pObject)
{
