...
class wxsPropertyAddLines: public wxsCustomEditorProperty
{
	public:
         ...
         */
		wxsPropertyAddLines(long nLineOffset, const wxString& PGName,const wxString& DataName, int Priority=100);
 ...
 */
#define WXS_ADDLINE(ClassName,Lines, PGName,DataName) \
    { static wxsPropertyAddLines _Property(wxsOFFSET(ClassName,Lines), PGName,DataName) \
      Property(_Property); }
 ...
 */
#define WXS_ADDLINE_P(ClassName,Lines,PGName,DataName, Priority) \
    { static wxsPropertyAddLines _Property(wxsOFFSET(ClassName,Lines), PGName,DataName, Priority); \
      Property(_Property); }
