    ...
    m_pBuilder(pBuilder)
{
	...
	m_plstTimeframe->ConnectToSetting(m_pBuilder->GetSection(), "Timeframe", reinterpret_cast<void*>(60));
	...
	m_plstPoints->ConnectToSetting(m_pBuilder->GetSection(), "RefreshRate", reinterpret_cast<void*>(250));
