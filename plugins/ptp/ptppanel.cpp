    ...
    m_bRunning(false)
{
	...
	m_plstClocks = new wmList(this, ID_M_PLST1, wxPoint(5,5), wxSize(190,470), wmList::STYLE_SELECT, 1, wxSize(-1,-1), 1, wxSize(-1,-1));
	...
	m_ptitleIdentity = new wmLabel(this, ID_M_PLBL1, _("Port Identitiy"), wxPoint(200,5), wxSize(100,30), 0, _T("ID_M_PLBL1"));
	...
	m_ptitleAddress = new wmLabel(this, ID_M_PLBL2, _("Address"), wxPoint(200,40), wxSize(100,30), 0, _T("ID_M_PLBL2"));
	...
	m_ptitleState = new wmLabel(this, ID_M_PLBL3, _("State"), wxPoint(200,75), wxSize(100,30), 0, _T("ID_M_PLBL3"));
	...
	m_plblIdentity = new wmLabel(this, ID_M_PLBL12, wxEmptyString, wxPoint(300,5), wxSize(180,30), 0, _T("ID_M_PLBL12"));
	...
	m_pblAddress = new wmLabel(this, ID_M_PLBL13, wxEmptyString, wxPoint(300,40), wxSize(180,30), 0, _T("ID_M_PLBL13"));
	...
	m_plblState = new wmLabel(this, ID_M_PLBL14, wxEmptyString, wxPoint(300,75), wxSize(180,30), 0, _T("ID_M_PLBL14"));
	...
	m_ppnlAnnouncements = new wxPanel(this, ID_PANEL1, wxPoint(200,110), wxSize(280,360), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	m_ppnlAnnouncements->SetBackgroundColour(wxColour(0,0,0));
	m_ptitleAnnouncements = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL30, _("Announcements"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL30"));
	...
	m_plblAnnCount = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL27, wxEmptyString, wxPoint(150,35), wxSize(130,30), 0, _T("ID_M_PLBL27"));
	...
	m_plblUTC = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL15, wxEmptyString, wxPoint(100,70), wxSize(180,30), 0, _T("ID_M_PLBL15"));
	...
	m_plblPriority1 = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL16, wxEmptyString, wxPoint(100,105), wxSize(180,30), 0, _T("ID_M_PLBL16"));
	...
	m_plblClass = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL17, wxEmptyString, wxPoint(100,140), wxSize(180,30), 0, _T("ID_M_PLBL17"));
	...
	m_plblAccuracy = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL18, wxEmptyString, wxPoint(100,175), wxSize(180,30), 0, _T("ID_M_PLBL18"));
	...
	m_plblVariance = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL19, wxEmptyString, wxPoint(100,210), wxSize(180,30), 0, _T("ID_M_PLBL19"));
	...
	m_plblPriority2 = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL20, wxEmptyString, wxPoint(100,245), wxSize(180,30), 0, _T("ID_M_PLBL20"));
	...
	m_plblSteps = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL21, wxEmptyString, wxPoint(100,280), wxSize(180,30), 0, _T("ID_M_PLBL21"));
	...
	m_plblSource = new wmLabel(m_ppnlAnnouncements, ID_M_PLBL22, wxEmptyString, wxPoint(100,315), wxSize(180,30), 0, _T("ID_M_PLBL22"));
	...
	m_pswp = new wmSwitcherPanel(this, ID_M_PSWP1, wxPoint(490,5), wxSize(280,245), wmSwitcherPanel::STYLE_NOSWIPE|wmSwitcherPanel::STYLE_NOANIMATION, _T("ID_M_PSWP1"));
	...
	m_ppnlSync = new wxPanel(m_ppnlMaster, ID_PANEL2, wxPoint(0,0), wxSize(280,105), wxTAB_TRAVERSAL, _T("ID_PANEL2"));
	m_ppnlSync->SetBackgroundColour(wxColour(0,0,0));
	m_ptitleSync = new wmLabel(m_ppnlSync, ID_M_PLBL23, _("Sync"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL23"));
	...
	m_plblSyncCount = new wmLabel(m_ppnlSync, ID_M_PLBL34, wxEmptyString, wxPoint(150,35), wxSize(130,30), 0, _T("ID_M_PLBL34"));
	...
	m_plblSyncMessage = new wmLabel(m_ppnlSync, ID_M_PLBL35, wxEmptyString, wxPoint(0,70), wxSize(280,30), 0, _T("ID_M_PLBL35"));
	...
	m_ppnlFollowUp = new wxPanel(m_ppnlMaster, ID_PANEL3, wxPoint(0,105), wxSize(280,105), wxTAB_TRAVERSAL, _T("ID_PANEL3"));
	m_ppnlFollowUp->SetBackgroundColour(wxColour(0,0,0));
	m_ptitleFollowUp = new wmLabel(m_ppnlFollowUp, ID_M_PLBL28, _("Follow Up"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL28"));
	...
	m_plblFollowCount = new wmLabel(m_ppnlFollowUp, ID_M_PLBL38, wxEmptyString, wxPoint(150,35), wxSize(130,30), 0, _T("ID_M_PLBL38"));
	...
	m_plblFollowMessage = new wmLabel(m_ppnlFollowUp, ID_M_PLBL39, wxEmptyString, wxPoint(0,70), wxSize(280,30), 0, _T("ID_M_PLBL39"));
	...
	m_ppnlRequests = new wxPanel(m_ppnlSlave, ID_PANEL4, wxPoint(0,0), wxSize(280,140), wxTAB_TRAVERSAL, _T("ID_PANEL4"));
	m_ppnlRequests->SetBackgroundColour(wxColour(0,0,0));
	m_ptitleDelay = new wmLabel(m_ppnlRequests, ID_M_PLBL40, _("Delay Requests"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL40"));
	...
	m_plblDelayCount = new wmLabel(m_ppnlRequests, ID_M_PLBL44, wxEmptyString, wxPoint(150,35), wxSize(130,30), 0, _T("ID_M_PLBL44"));
	...
	m_plblDelayMessage = new wmLabel(m_ppnlRequests, ID_M_PLBL45, wxEmptyString, wxPoint(0,70), wxSize(280,30), 0, _T("ID_M_PLBL45"));
	...
	m_plblDelayMech = new wmLabel(m_ppnlRequests, ID_M_PLBL47, wxEmptyString, wxPoint(100,105), wxSize(180,30), 0, _T("ID_M_PLBL47"));
	...
	m_ppnlResponses = new wxPanel(m_ppnlSlave, ID_PANEL7, wxPoint(0,140), wxSize(280,140), wxTAB_TRAVERSAL, _T("ID_PANEL7"));
	m_ppnlResponses->SetBackgroundColour(wxColour(0,0,0));
	m_pLbl1 = new wmLabel(m_ppnlResponses, ID_M_PLBL48, _("Delay Responses Received"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL48"));
	...
	m_plblResponseCount = new wmLabel(m_ppnlResponses, ID_M_PLBL52, wxEmptyString, wxPoint(150,35), wxSize(130,30), 0, _T("ID_M_PLBL52"));
	...
	m_plblResponseMessage = new wmLabel(m_ppnlResponses, ID_M_PLBL53, wxEmptyString, wxPoint(0,70), wxSize(280,30), 0, _T("ID_M_PLBL53"));
	...
	m_ppnlLocal = new wxPanel(this, ID_PANEL8, wxPoint(490,250), wxSize(280,205), wxTAB_TRAVERSAL, _T("ID_PANEL8"));
	m_ppnlLocal->SetBackgroundColour(wxColour(0,0,0));
	m_ptitlePam = new wmLabel(m_ppnlLocal, ID_M_PLBL54, _("PAM"), wxPoint(0,0), wxSize(280,30), 0, _T("ID_M_PLBL54"));
	...
	m_plblOffsetAverage = new wmLabel(m_ppnlLocal, ID_M_PLBL61, wxEmptyString, wxPoint(100,70), wxSize(180,30), 0, _T("ID_M_PLBL61"));
	...
	m_plblOffsetRange = new wmLabel(m_ppnlLocal, ID_M_PLBL62, wxEmptyString, wxPoint(100,105), wxSize(180,30), 0, _T("ID_M_PLBL62"));
	...
	m_plblDelayAverage = new wmLabel(m_ppnlLocal, ID_M_PLBL63, wxEmptyString, wxPoint(100,140), wxSize(180,30), 0, _T("ID_M_PLBL63"));
	...
	m_plblDelayRange = new wmLabel(m_ppnlLocal, ID_M_PLBL64, wxEmptyString, wxPoint(100,175), wxSize(180,30), 0, _T("ID_M_PLBL64"));
