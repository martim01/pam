    ...
    m_bRunning(false)
{
	...
	m_ptitleIdentity = new wmLabel(this, ID_M_PLBL1, _("Port Identitiy"), wxPoint(5,5), wxSize(100,30), 0, _T("ID_M_PLBL1"));
	...
	m_ptitleAddress = new wmLabel(this, ID_M_PLBL2, _("Address"), wxPoint(5,40), wxSize(100,30), 0, _T("ID_M_PLBL2"));
	...
	m_ptitleState = new wmLabel(this, ID_M_PLBL3, _("State"), wxPoint(5,75), wxSize(100,30), 0, _T("ID_M_PLBL3"));
	...
	m_plblIdentity = new wmLabel(this, ID_M_PLBL12, wxEmptyString, wxPoint(105,5), wxSize(180,30), 0, _T("ID_M_PLBL12"));
	...
	m_pblAddress = new wmLabel(this, ID_M_PLBL13, wxEmptyString, wxPoint(105,40), wxSize(180,30), 0, _T("ID_M_PLBL13"));
	...
	m_plblState = new wmLabel(this, ID_M_PLBL14, wxEmptyString, wxPoint(105,75), wxSize(180,30), 0, _T("ID_M_PLBL14"));
	...
	m_ppnlAnnouncements = new wxPanel(this, ID_PANEL1, wxPoint(5,110), wxSize(280,360), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	...
	m_pswp = new wmSwitcherPanel(this, ID_M_PSWP1, wxPoint(295,5), wxSize(280,245), wmSwitcherPanel::STYLE_NOSWIPE|wmSwitcherPanel::STYLE_NOANIMATION, _T("ID_M_PSWP1"));
	...
	m_ppnlLocal = new wxPanel(this, ID_PANEL8, wxPoint(295,250), wxSize(280,205), wxTAB_TRAVERSAL, _T("ID_PANEL8"));
