    ...
    m_pBuilder(pBuilder)
{
	...
	m_pbtnRotate->SetToogle(true, wxT("LvR"), wxT("MvS"), 50.0);
	m_pbtnLevels->SetToogle(true, wxT("Hide"), wxT("Show"), 50.0);
	m_pbtnDisplay->SetToogle(true, wxT("Stars"), wxT("Hull"), 50.0);
