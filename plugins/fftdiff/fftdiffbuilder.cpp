...
fftdiffBuilder::fftdiffBuilder() : TestPluginBuilder()
{
    ...
    RegisterRemoteApiRangeInt("ChannelA", {0,7},0);   //@todo this should be dynamic based on sessions
    RegisterRemoteApiRangeInt("ChannelB", {0,7},1);   //@todo this should be dynamic based on sessions
