...
{
    m_pGraph->SetSampleRate(aSession.nSampleRate);
    m_nTotalChannels = aSession.nChannels;
    ...
    {
        m_plstChannel1->AddButton(wxString::Format(wxT("Ch %d"), i));
        m_plstChannel2->AddButton(wxString::Format(wxT("Ch %d"), i));
    }
