    ...
    m_pUnicastStreamer(nullptr)
{
	...
	m_pLbl2 = new wmLabel(this, ID_M_PLBL3, _("On Demand MP3 Streamer"), wxPoint(0,0), wxSize(446,38), 0, _T("ID_M_PLBL3"));
	...
	m_plblUnicastUrl = new wmLabel(m_ppnlUnicast, ID_M_PLBL9, wxEmptyString, wxPoint(146,5), wxSize(300,40), 0, _T("ID_M_PLBL9"));
	...
	m_plblConnections = new wmLabel(m_ppnlUnicast, ID_M_PLBL2, _("Connections"), wxPoint(0,46), wxSize(446,28), 0, _T("ID_M_PLBL2"));
	...
	m_plstConnections = new wmList(m_ppnlUnicast, ID_M_PLST1, wxPoint(0,75), wxSize(446,360), 0, 1, wxSize(-1,25), 1, wxSize(-1,-1));
