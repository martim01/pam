...
DEP_LINUX_RELEASE = 
OUT_LINUX_RELEASE = ../../lib/test/librecord.so

OBJ_LINUX_RELEASE = $(OBJDIR_LINUX_RELEASE)/pnlRecord.o $(OBJDIR_LINUX_RELEASE)/record.o $(OBJDIR_LINUX_RELEASE)/recordbuilder.o $(OBJDIR_LINUX_RELEASE)/recordthread.o
...
$(OBJDIR_LINUX_RELEASE)/pnlRecord.o: pnlRecord.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c pnlRecord.cpp -o $(OBJDIR_LINUX_RELEASE)/pnlRecord.o

$(OBJDIR_LINUX_RELEASE)/record.o: record.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c record.cpp -o $(OBJDIR_LINUX_RELEASE)/record.o

$(OBJDIR_LINUX_RELEASE)/recordbuilder.o: recordbuilder.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c recordbuilder.cpp -o $(OBJDIR_LINUX_RELEASE)/recordbuilder.o

$(OBJDIR_LINUX_RELEASE)/recordthread.o: recordthread.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c recordthread.cpp -o $(OBJDIR_LINUX_RELEASE)/recordthread.o
