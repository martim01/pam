...
DEP_LINUX_RELEASE = 
OUT_LINUX_RELEASE = ../../lib/test/libidentify.so

OBJ_LINUX_RELEASE = $(OBJDIR_LINUX_RELEASE)/identify.o $(OBJDIR_LINUX_RELEASE)/identifybuilder.o $(OBJDIR_LINUX_RELEASE)/myprocess.o $(OBJDIR_LINUX_RELEASE)/pnlIdentify.o
...
$(OBJDIR_LINUX_RELEASE)/identify.o: identify.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c identify.cpp -o $(OBJDIR_LINUX_RELEASE)/identify.o

$(OBJDIR_LINUX_RELEASE)/identifybuilder.o: identifybuilder.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c identifybuilder.cpp -o $(OBJDIR_LINUX_RELEASE)/identifybuilder.o

$(OBJDIR_LINUX_RELEASE)/myprocess.o: myprocess.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c myprocess.cpp -o $(OBJDIR_LINUX_RELEASE)/myprocess.o

$(OBJDIR_LINUX_RELEASE)/pnlIdentify.o: pnlIdentify.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c pnlIdentify.cpp -o $(OBJDIR_LINUX_RELEASE)/pnlIdentify.o
